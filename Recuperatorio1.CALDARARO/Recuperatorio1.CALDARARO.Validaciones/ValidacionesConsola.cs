...
namespace Recuperatorio1.CALDARARO.Validaciones
{
    public class ValidacionesConsola
    {
        ...
        public static string PedirOpcion(string op1, string op2, string op3, string op4)
        {
            ...
            do
            {
                ...
                if (opcion == op1 || opcion == op2 || opcion == op3 || opcion == op4)
                    break;
                else
                    Console.WriteLine("Ingreso inválido. Vuelva a intentarlo.");
            } while (opcion != op1 && opcion != op2 && opcion != op3 && opcion != op4);
        ...
        public static string PedirCUIT()
        {
